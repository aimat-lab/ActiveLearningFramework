...
if __name__ == '__main__':
    ...
    x, x_test, y, y_test = x_loaded[properties.test_set_size:32], x_loaded[:properties.test_set_size], [eng[properties.test_set_size:32], grads[properties.test_set_size:32]], [eng[:properties.test_set_size], grads[:properties.test_set_size]]
    ...
    reduced_x, reduced_y = np.load(os.path.join(properties.al_training_data_storage_location, properties.al_training_data_storage_x)), np.load(os.path.join(properties.al_training_data_storage_location, properties.al_training_data_storage_x))
    ip_results = run_evaluation_reduced_sl_model(flat_x=reduced_x, flat_x_test=x_test, flat_y=reduced_y, flat_y_test=y_test)
