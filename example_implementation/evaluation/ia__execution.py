...
from example_implementation.al_implementations.active_initiator import HousingInitiator
...
def run_al(x, x_test, y, y_test):
    ...
    try:
        init_helper: InitiationHelper = HousingInitiator(x=x, x_test=x_test, y=y, y_test=y_test)
    ...
    _, mae_test, r2_test = calc_final_evaluation(pred_test, y_test, "IA test set", properties.eval_entities["ia"] + "_test" + properties.prediction_image_suffix)
    _, mae_train, r2_train = calc_final_evaluation(pred_train, y, "IA train set", properties.eval_entities["ia"] + "_train" + properties.prediction_image_suffix)
