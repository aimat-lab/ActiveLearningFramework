...
class SLModel:
    ...
    def __init__(self, x_test, y_test, entity=properties.eval_entities["ip"]):
        self._entity = entity
    ...
    def train(self, x, y, batch_size, max_epochs, min_epochs, thr):
        ...
        feat_x, feat_grad = self._model.precompute_feature_in_chunks(x_scaled, batch_size=batch_size)
